...
var j;
var k;
var a_m = prompt("Você quer que a matriz seja manual(digite 1) ou aleatória(digite 2)(números limitados de 1 - 10)");
var aleatorio;
...
//multiplicação
//Não entendi por que que esse if não funcionou.
//if(matriz[i].length == matriz_I[x].length){
...
document.write("A mensagem de erro é um pouco bugada, mas passa a mensagem");
//}else{
//  document.write("Matriz impossível");
//}
